...
- **Self-Hosted Provider Sources**: Includes vendored source mirrors for 9 external tunnel projects under `third_party/tunnels`
...
For ready-to-copy templates, see `INSTALLATION_EXAMPLE.md`.
